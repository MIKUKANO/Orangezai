    ...
    new (class ComWeChatAdapter {
        ...
        async makeMsg(data, msg, send) {
            ...
            for (let i of msg) {
                ...
                if (i.data.file)
                    i.data = {
                        file_id: (await this.uploadFile(data, i.data)).file_id
                    }
        ...
        async getFriendMap(data) {
            for (const i of await this.getFriendArray(data)) data.bot.fl.set(i.user_id, i)
            return data.bot.fl
        }
        ...
        async getGroupMap(data) {
            for (const i of await this.getGroupArray(data)) data.bot.gl.set(i.group_id, i)
            return data.bot.gl
        }
