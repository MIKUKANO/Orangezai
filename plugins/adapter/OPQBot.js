        ...
        message(data, ws) {
            ...
            if (id && data.CurrentPacket) {
                ...
                if (data.CgiBaseResponse?.Ret !== 0)
                    this.echo[data.ReqId].reject(
                        Object.assign(this.echo[data.ReqId].error, this.echo[data.ReqId].request, {
                            error: data
                        })
                    )
                else this.echo[data.ReqId].resolve(data)
